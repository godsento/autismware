...
void Client::DrawHUD() {
	...
	std::string text = tfm::format(XOR("AutismWare | Build: " __DATE__ " | latency: %i ms"), ms);
...
void Client::ClanTag()
{
	...
	if (g_menu.main.misc.clantag.get()) {
		...
		if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 3.6) % 14) {
			...
			case 1: {  SetClanTag("A"); break; }
			case 2: {  SetClanTag("Au"); break; }
			case 3: {  SetClanTag("Aut"); break; }
			case 4: {  SetClanTag("Auti"); break; }
			case 5: {  SetClanTag("Autis"); break; }
			case 6: {  SetClanTag("Autist"); break; }
			case 7: {  SetClanTag("Autism"); break; }
			case 8: {  SetClanTag("Autist"); break; }
			case 9: {  SetClanTag("Autis"); break; }
			case 10: { SetClanTag("Auti"); break; }
			case 11: { SetClanTag("Aut"); break; }
			case 12: { SetClanTag("Au"); break; }
			case 13: { SetClanTag("A");	break; }
			case 14: { SetClanTag(" ");	break; }
...
void Client::print(const std::string text, ...) {
	...
	// print to console.
	g_csgo.m_cvar->ConsoleColorPrintf(colors::green, XOR("[AutismWare] "));
